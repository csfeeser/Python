...
- (Incorrect) **The None value can be assigned to variables.**
...
- (Incorrect) **Continue statements exit the loop.**
...
- (Incorrect) **The code will enter an infinite loop.**
...
- (Incorrect) **True, False, False, False, True**
...
- (Incorrect) **It doesnâ€™t change the list.**
...
- (Incorrect) **You can use keywords as variable names in Python.**
...
- (Incorrect) **A medium-level programming language consisting of assembly code designed for the computer processor.**
...
### Options:
- (Incorrect) **create a docstring.**
  - The digraph `#!` is not used to create a docstring. Docstrings are created using triple quotes (`'''` or `"""`).

- (Incorrect) **tell an MS Windows OS how to execute the contents of a Python file.**
...
- (Incorrect) **make a particular module entity a private one.**
  - The `#!` digraph does not relate to privacy in Python modules. Underscores (`_`) are used for this purpose.

- (Correct) **tell a Unix or Unix-like OS how to execute the contents of a Python file.**
...
### Options:
- (Incorrect) **It is a programming language that is a superset of the C language, designed to produce Python-like performance with code written in C.
**
...
- (Incorrect) **It is a programming language that is a superset of Python, designed to produce C-like performance with code written in Python.
**
  - CPython is not a programming language or a superset of Python. It is the default implementation of Python, written in C.

- (Incorrect) **It is a default, reference implementation of the C language, written in Python.
**
...
- (Correct) **It is a default, reference implementation of the Python language, written in C.
**
...
### Options:
- (Incorrect) **will not affect the argument**
...
- (Correct) **will affect the argument**
...
- (Correct) **The program will cause an error**
...
- (Incorrect) **The snippet will enter an infinite loop.**
...
### Options:
- (Incorrect) **It's a programming language that is a superset of the C language, designed to produce Python-like performance with code written in C.**
  - CPython is not a programming language. It is the reference implementation of Python, written in C.

- (Incorrect) **It's a programming language that is a superset of Python, designed to produce C-like performance with code written in Python.**
...
- (Incorrect) **It's a default, reference implementation of the C language, written in Python.**
  - CPython is not an implementation of the C language. It is an implementation of the Python language, written in C.

- (Correct) **It's a default, reference implementation of the Python language, written in C.**
...
- (Correct) **nums and vals refer to the same list**
...
### Options:
- (Correct) **The code will raise the SyntaxError exception.**
...
### Options:
- (Incorrect) **The program will cause a ValueError exception and output a default error message.**
...
- (Incorrect) **The program will raise an exception handled by the first except block.**
...
- (Correct) **The program will cause a SyntaxError exception.**
...
- (Incorrect) **The program will cause a ZeroDivisionError exception and output a default error message.**
...
- (Incorrect) **The program will cause a ValueError exception and output the following message: 'Too bad...'**
...
### Options:
- (Incorrect) **An alphabet, phonetics, phonology, and semantics**
...
- (Correct) **An alphabet, a lexis, a syntax, and semantics**
...
- (Incorrect) **An alphabet, morphology, phonetics, and semantics**
...
- (Incorrect) **An alphabet, a lexis, phonetics, and semantics**
